...
\once\override Beam #'positions = #'(6 . 10)  \tuplet 3/2{ \once\override Hairpin #'rotation = #'(7 0 0)  g8[(\(^\<  fis) <a g'>(   \override Fingering #'avoid-slur = #'ignore   fis'-\tweak #'Y-offset #3 -2 -\tweak #'Y-offset #5 -4) <a g'>( <dis fis>]\!)\)}\times 2/3{ \once\override Hairpin #'rotation = #'(-7 0 0)  <g, fis'>^\>[\accent(\( <b e>) <g, fis'>( <b e>) fis^1^5 -\tweak #'X-offset #-2 -\tweak #'Y-offset #-2 -5 (  e_4)\)\!]} %\bar 4 
...
\omit TupletNumber\omit TupletBracket  <a, c>4\accent  c'8.-\tweak #'Y-offset #0 -\tweak #'X-offset #-3 -2\accent   \change Staff = "left" \stemUp c16^\accent c4-\tweak #'Y-offset #7.5 -2 -\tweak #'Y-offset #9 -1-\tweak #'Y-offset #11 ^\accent c,8.-\tweak #'Y-offset #4 -1 ^\accent \change Staff = "right" \stemDown c16 -\tweak #'X-offset #0.2 -\tweak #'Y-offset #-5 -2\accent %\bar3
  <a c>4\accent \tuplet 3/2{ d'!8\accent^\( \change Staff = "left" \stemUp c8.^\accent    \once \override Script.avoid-slur = #'inside   b16^\accent} \override Fingering #'avoid-slur = #'ignore  \once \override Script.avoid-slur = #'inside   b4-\tweak #'Y-offset #6.8 -1^\accent \) \tuplet 3/2 {    d,8-\tweak #'Y-offset #4.3 ^2 -\tweak #'Y-offset #5.6 ^1^\accent\( \change Staff = "right" \stemDown \once\override Hairpin #'rotation = #'(1 43 0)  c8. -\tweak #'X-offset #-2 -\tweak #'Y-offset #-4 -2\accent _\<  \override Fingering #'avoid-slur = #'ignore   \once \override Script.avoid-slur = #'inside   b16-\tweak #'Y-offset #-2 -1 -\tweak #'Y-offset #-.5 -\tenuto -\tweak #'Y-offset #0 -2 \accent \! }%bar 4
